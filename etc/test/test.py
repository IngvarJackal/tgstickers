...
print("\n+++++++++++++++++++++++++++++++++++++++++ SERVER DEPLOYMENT ++++++++++++++++++++++++++++++++++++++++++")
deploymentSubprocess = subprocess.Popen("ssh -i /tmp/deployment_key travis@35.188.89.38 'wget -q https://raw.githubusercontent.com/IngvarJackal/tgstickers/master/etc/prod/restart.sh -O redeploy.sh && nohup sh redeploy.sh &'", shell=True)
